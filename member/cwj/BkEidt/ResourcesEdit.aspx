<%@ Page Title="" Language="C#" MasterPageFile="~/member/cwj/BkEidt/ChanEditMain.Master" AutoEventWireup="true" CodeBehind="ResourcesEdit.aspx.cs" Inherits="ChanWeb.BkEidt.LinksEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h2><a href="../Resources.aspx" target="_blank">Resources.aspx</a>(外部资源链接)页面插入、删除、更新后台操作!</h2>
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DD_SelectedIndexChanged">
            <asp:ListItem Value="1">学者主页</asp:ListItem>
            <asp:ListItem Value="2">期刊</asp:ListItem>
            <asp:ListItem Value="3">会议</asp:ListItem>
            <asp:ListItem Value="4">工具</asp:ListItem>
            <asp:ListItem Value="5">课程</asp:ListItem>
        </asp:DropDownList>
        <br />
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" DataSourceID="DB" InsertItemPosition="LastItem">
            <AlternatingItemTemplate>
                <tr style="background-color: #FFF8DC;">
                    ...
                    <td>
                        <asp:Label ID="link_tipLabel" TextMode="MultiLine" Width="100%" runat="server" Text='<%# Eval("link_tip") %>' />
                    </td>
                    <td>
            ...
            <EditItemTemplate>
                <tr style="background-color: #ff0000; color: #FFFFFF;">
                    ...
                    <td>
                        <asp:TextBox ID="link_tipTextBox" TextMode="MultiLine" Width="100%" runat="server" Text='<%# Bind("link_tip") %>' />
                    </td>
                    <td>
                        ...
                        <td runat="server">
                            <table id="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px; font-family: Verdana, Arial, Helvetica, sans-serif;">
                                <tr runat="server" style="background-color: #DCDCDC; color: #000000;">
                                    ...
                                    <th style="width: 400px" runat="server">提示</th>
                                    <th style="width: 400px" runat="server">链接</th>
                                    <th style="width: 40px" runat="server"><span class="redFont">类型</span></th>
                                </tr>
            ...
            <SelectedItemTemplate>
                <tr style="background-color: #008A8C; font-weight: bold; color: #FFFFFF;">
                    ...
                    <td>
                        <asp:Label ID="link_tipLabel" runat="server" Text='<%# Eval("link_tip") %>' />
                    </td>
                    <td>
                        <asp:Label ID="link_urlLabel" runat="server" Text='<%# Eval("link_url") %>' />
                    </td>
        ...
        <asp:AccessDataSource ID="DB" runat="server" DataFile="~/member/cwj/DB/ChanDB.mdb"
            SelectCommand="SELECT * FROM [Links] WHERE ([link_type] = ?)"
            DeleteCommand="DELETE FROM [Links] WHERE [ID] = ?"
            InsertCommand="INSERT INTO [Links] ([link_name], [link_discription],[link_tip] ,[link_url], [link_type]) VALUES (?, ?, ?, ?, ?)"
            UpdateCommand="UPDATE [Links] SET [link_name] = ?, [link_discription] = ?, [link_tip]=?, [link_url] = ?, [link_type] = ? WHERE [ID] = ?">
            <DeleteParameters>
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="link_tip" Type="String" />
